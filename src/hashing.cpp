...
int64_t plasma::vm::virtual_machine::hash_array(const std::vector<int64_t> &values) {
    return MurmurHash64(&(*values.begin()), values.size(), this->seed);
}

int64_t plasma::vm::virtual_machine::hash_string(const std::string &string) {
